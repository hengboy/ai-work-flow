...
- **Structured handoff**：`planning_context`、`change_evidence`、`review_packet`、`review_axis_result` 与 `review_result` 直接以完整对象传递。
...
| `execution-runtime/lib/workflow-contract.mjs` | 校验 contract/schema digest、action I/O、`TaskResult` 类型和直接结构化内容。 |
